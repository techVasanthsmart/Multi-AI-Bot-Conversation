...
import {
  Character,
  CharacterCard,
} from "@/components/character/character-card";
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(async () => {
      ...
      if (lastBotMessage) {
        const lastIndex = characters.findIndex(
          (c) => c.name === lastBotMessage.senderName,
        );
        if (lastIndex !== -1) {
      ...
      try {
        ...
        // Create initial message with streaming ID
        setMessages((prev) => [
          ...prev,
          {
            id: messageId,
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <header className="text-center space-y-4 mb-12">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto text-lg">
            Create a chaotic orchestra of distinct AI personalities and watch
            them interact.
          </p>
        </header>
        ...
        {!isChatStarted ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              {/* Start Controls */}
              <div className="p-6 rounded-xl border border-slate-200/50 bg-gradient-to-r from-violet-100 to-fuchsia-100 mt-8 shadow-sm">
                <div className="flex flex-col md:flex-row gap-4 items-end">
                  <div className="flex-1 w-full space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-white text-slate-900 placeholder:text-slate-400 focus:bg-white "
                    />
                  </div>
                  <Button
                    size="lg"
          ...
          <div className="space-y-6 max-w-5xl mx-auto mt-8">
            <div className="flex items-center justify-between">
              <Button
                ...
                className="text-slate-600 border border-slate-200 transition-opacity hover:opacity-80 hover:bg-transparent"
              >
